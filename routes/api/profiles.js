...
router.get('/handle/:handle', (req, res) => {
    ...
    .then(profile => {
        if(!profile) {
            ...
            errors.noprofile = 'There is no profile available for this user';
...
router.post('/', passport.authenticate('jwt', {session: false}), (req, res) => {
    ...
    .then(profile => {
        if(profile){
            //this is an update, not new profile
...
router.post('/experience', passport.authenticate('jwt', {session: false}), (req, res) =>{
    ...
    .then(profile => {
        ...
        // Add to experience array (unshift adds to array in correct order from beginning,
        // push would be backwards)
        profile.experience.unshift(newExp);

        //save the changed profile and return new result
